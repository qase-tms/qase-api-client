...
class ProjectCounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'suites' => 'int',
        'milestones' => 'int',
        'runs' => '\Qase\APIClientV1\Model\ProjectCountsRuns',
        'defects' => '\Qase\APIClientV1\Model\ProjectCountsDefects'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('defects', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets runs
     *
     * @return \Qase\APIClientV1\Model\ProjectCountsRuns|null
     */
     ...
     * Sets runs
     *
     * @param \Qase\APIClientV1\Model\ProjectCountsRuns|null $runs runs
     *
     * @return self
     */
     ...
     * Gets defects
     *
     * @return \Qase\APIClientV1\Model\ProjectCountsDefects|null
     */
     ...
     * Sets defects
     *
     * @param \Qase\APIClientV1\Model\ProjectCountsDefects|null $defects defects
     *
     * @return self
     */
    ...
    {
        if (is_null($defects)) {
            throw new \InvalidArgumentException('non-nullable defects cannot be null');
        }
