...
class TestStep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sharedStepHash', $data ?? [], null);
        $this->setIfExists('sharedStepNestedHash', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($sharedStepHash)) {
            array_push($this->openAPINullablesSetToNull, 'sharedStepHash');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sharedStepHash', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($sharedStepNestedHash)) {
            array_push($this->openAPINullablesSetToNull, 'sharedStepNestedHash');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sharedStepNestedHash', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
