...
class ResultCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'caseId' => 'int',
        'case' => '\Qase\APIClientV1\Model\ResultCreateCase',
        'startTime' => 'int',
        'time' => 'int',
        'timeMs' => 'int',
        'defect' => 'bool',
        ...
        'paramGroups' => 'string[][]',
        'steps' => '\Qase\APIClientV1\Model\TestStepResultCreate[]',
        'authorId' => 'int'
    ];
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Can have the following values `passed`, `failed`, `blocked`, `skipped`, `invalid` + custom statuses
     *
     * @return self
     */
     ...
     * Gets case
     *
     * @return \Qase\APIClientV1\Model\ResultCreateCase|null
     */
     ...
     * Sets case
     *
     * @param \Qase\APIClientV1\Model\ResultCreateCase|null $case case
     *
     * @return self
     */
    ...
    public function setStartTime($startTime)
    {
        ...
        if (!is_null($startTime) && ($startTime < 0)) {
            throw new \InvalidArgumentException('invalid value for $startTime when calling ResultCreate., must be bigger than or equal to 0.');
        }
     ...
     * Sets paramGroups
     *
     * @param string[][]|null $paramGroups List parameter groups by name only. Add their values in the 'param' field
     *
     * @return self
     */
     ...
     * Gets steps
     *
     * @return \Qase\APIClientV1\Model\TestStepResultCreate[]|null
     */
     ...
     * Sets steps
     *
     * @param \Qase\APIClientV1\Model\TestStepResultCreate[]|null $steps steps
     *
     * @return self
     */
