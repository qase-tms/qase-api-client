...
class PlanDetailed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'updated' => 'string',
        'averageTime' => 'float',
        'cases' => '\Qase\APIClientV1\Model\PlanDetailedAllOfCases[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('averageTime', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($averageTime)) {
            throw new \InvalidArgumentException('non-nullable averageTime cannot be null');
        }
     ...
     * Gets cases
     *
     * @return \Qase\APIClientV1\Model\PlanDetailedAllOfCases[]|null
     */
     ...
     * Sets cases
     *
     * @param \Qase\APIClientV1\Model\PlanDetailedAllOfCases[]|null $cases cases
     *
     * @return self
     */
