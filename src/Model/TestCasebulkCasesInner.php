...
/**
 * TestCasebulkCasesInner Class Doc Comment
 *
 * @category Class
 * @package  Qase\APIClientV1
 * @author   OpenAPI Generator team
 ...
 */
class TestCasebulkCasesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TestCasebulk_cases_inner';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling TestCasebulkCasesInner., must be smaller than or equal to 255.');
        }
    ...
    {
        if (is_null($suiteId)) {
            throw new \InvalidArgumentException('non-nullable suiteId cannot be null');
        }
     ...
     * Gets steps
     *
     * @return \Qase\APIClientV1\Model\TestStepCreate[]|null
     */
     ...
     * Sets steps
     *
     * @param \Qase\APIClientV1\Model\TestStepCreate[]|null $steps steps
     *
     * @return self
     */
