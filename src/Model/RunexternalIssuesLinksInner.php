...
/**
 * RunexternalIssuesLinksInner Class Doc Comment
 *
 * @category Class
 * @package  Qase\APIClientV1
 * @author   OpenAPI Generator team
 ...
 */
class RunexternalIssuesLinksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Runexternal_issues_links_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['externalIssue']) && (mb_strlen($this->container['externalIssue']) < 1)) {
            $invalidProperties[] = "invalid value for 'externalIssue', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets externalIssue
     *
     * @param string|null $externalIssue An external issue identifier, e.g. \"PROJ-1234\". Or null if you want to remove the link.
     *
     * @return self
     */
    public function setExternalIssue($externalIssue)
    {
        ...
        if (!is_null($externalIssue) && (mb_strlen($externalIssue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $externalIssue when calling RunexternalIssuesLinksInner., must be bigger than or equal to 1.');
        }
