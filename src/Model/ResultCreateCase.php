...
class ResultCreateCase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('suiteTitle', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($suiteTitle)) {
            array_push($this->openAPINullablesSetToNull, 'suiteTitle');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('suiteTitle', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets layer
     *
     * @param string|null $layer Slug of the layer. You can get it in the System Field settings.
     *
     * @return self
     */
     ...
     * Sets severity
     *
     * @param string|null $severity Slug of the severity. You can get it in the System Field settings.
     *
     * @return self
     */
     ...
     * Sets priority
     *
     * @param string|null $priority Slug of the priority. You can get it in the System Field settings.
     *
     * @return self
     */
