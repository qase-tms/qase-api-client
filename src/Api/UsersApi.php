...
class UsersApi
{
     ...
     * @return \Qase\APIClientV1\Model\UserResponse
     */
     ...
     * @throws \Qase\APIClientV1\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Qase\APIClientV1\Model\UserResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Qase\APIClientV1\Model\UserResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Qase\APIClientV1\Model\UserResponse';
        $request = $this->getUserRequest($id, $contentType);
     ...
     * @throws \Qase\APIClientV1\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Qase\APIClientV1\Model\UserListResponse
     */
    public function getUsers($limit = 10, $offset = 0, string $contentType = self::contentTypes['getUsers'][0])
    {
        list($response) = $this->getUsersWithHttpInfo($limit, $offset, $contentType);
        return $response;
    }
     ...
     * @throws \Qase\APIClientV1\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Qase\APIClientV1\Model\UserListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUsersWithHttpInfo($limit = 10, $offset = 0, string $contentType = self::contentTypes['getUsers'][0])
    {
        $request = $this->getUsersRequest($limit, $offset, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Qase\APIClientV1\Model\UserListResponse',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUsersAsync($limit = 10, $offset = 0, string $contentType = self::contentTypes['getUsers'][0])
    {
        return $this->getUsersAsyncWithHttpInfo($limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUsersAsyncWithHttpInfo($limit = 10, $offset = 0, string $contentType = self::contentTypes['getUsers'][0])
    {
        $returnType = '\Qase\APIClientV1\Model\UserListResponse';
        $request = $this->getUsersRequest($limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUsersRequest($limit = 10, $offset = 0, string $contentType = self::contentTypes['getUsers'][0])
    {
