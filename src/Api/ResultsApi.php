...
class ResultsApi
{
     ...
     *
     * @param  string $code Code of project, where to search entities. (required)
     * @param  string|null $status A single test run result status. Possible values: in_progress, passed, failed, blocked, skipped, invalid. (optional)
     * @param  string|null $run A list of run IDs separated by comma. (optional)
     * @param  string|null $caseId A list of case IDs separated by comma. (optional)
     * @param  string|null $member A list of member IDs separated by comma. (optional)
     * @param  bool|null $api api (optional)
     * @param  string|null $fromEndTime Will return all results created after provided datetime. Allowed format: &#x60;Y-m-d H:i:s&#x60;. (optional)
     * @param  string|null $toEndTime Will return all results created before provided datetime. Allowed format: &#x60;Y-m-d H:i:s&#x60;. (optional)
