...
class SearchApi
{
     ...
     * @return \Qase\APIClientV1\Model\SearchResponse
     */
    public function search($query, $limit = 10, $offset = 0, string $contentType = self::contentTypes['search'][0])
    {
        list($response) = $this->searchWithHttpInfo($query, $limit, $offset, $contentType);
        return $response;
    }
     ...
     * @throws \Qase\APIClientV1\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Qase\APIClientV1\Model\SearchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($query, $limit = 10, $offset = 0, string $contentType = self::contentTypes['search'][0])
    {
        $request = $this->searchRequest($query, $limit, $offset, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Qase\APIClientV1\Model\SearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Qase\APIClientV1\Model\SearchResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Qase\APIClientV1\Model\SearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Qase\APIClientV1\Model\SearchResponse';
     ...
     */
    public function searchAsync($query, $limit = 10, $offset = 0, string $contentType = self::contentTypes['search'][0])
    {
        return $this->searchAsyncWithHttpInfo($query, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($query, $limit = 10, $offset = 0, string $contentType = self::contentTypes['search'][0])
    {
        $returnType = '\Qase\APIClientV1\Model\SearchResponse';
        $request = $this->searchRequest($query, $limit, $offset, $contentType);
     ...
     */
    public function searchRequest($query, $limit = 10, $offset = 0, string $contentType = self::contentTypes['search'][0])
    {
