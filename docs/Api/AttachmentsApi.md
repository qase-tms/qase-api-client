# Qase\APIClientV1\AttachmentsApi
...
```php
deleteAttachment($hash): \Qase\APIClientV1\Model\HashResponse
```
...
$apiInstance = new Qase\APIClientV1\Api\AttachmentsApi(
...
```php
getAttachment($hash): \Qase\APIClientV1\Model\AttachmentResponse
```
...
[**\Qase\APIClientV1\Model\AttachmentResponse**](../Model/AttachmentResponse.md)
...
```php
getAttachments($limit, $offset): \Qase\APIClientV1\Model\AttachmentListResponse
```
...
[**\Qase\APIClientV1\Model\AttachmentListResponse**](../Model/AttachmentListResponse.md)
...
```php
uploadAttachment($code, $file): \Qase\APIClientV1\Model\AttachmentUploadsResponse
```
...
[**\Qase\APIClientV1\Model\AttachmentUploadsResponse**](../Model/AttachmentUploadsResponse.md)
